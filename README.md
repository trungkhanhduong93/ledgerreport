# 📊 iPOS Ledger Studio (`ledgerreport`)
...
Tải file thực thi `iPOS_Ledger_Studio.exe` dành cho Windows tại trang **GitHub Releases**:  
👉 [https://github.com/trungkhanhduong93/ledgerreport/releases](https://github.com/trungkhanhduong93/ledgerreport/releases)